...
public class SubmitOrderDatProvHashMap extends BaseTest  {
	...
	public Object[][] getData()
	{
		...
		map.put("email","umamenon0506@gmail.com");
		map.put("password","Umadinu@82");
		map.put("productName", "ZARA COAT 3");
		
		HashMap<String,String> map1 = new HashMap<String,String>();
		map1.put("email","umadinesh5@gmail.com");
		map1.put("password","Umadinu@82");
